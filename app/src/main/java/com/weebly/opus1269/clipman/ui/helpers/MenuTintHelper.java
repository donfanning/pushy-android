 ...
 * <p>Example usage:</p>
 * <p/>
 * <pre class="prettyprint"> public boolean onCreateOptionsMenu(Menu menu) { ...
 * int color = getResources().getColor(R.color.your_awesome_color); int alpha =
 * 204; // 80% transparency MenuTintHelper.on(menu).setMenuItemIconColor(color).setMenuItemIconAlpha(alpha).apply(this);
 * ... } </pre>
 */
...
public class MenuTintHelper {
  ...
  /**
   * Sets the color filter and/or the alpha transparency on a {@link MenuItem}'s
   * icon.
   * @param menuItem The {@link MenuItem} to theme.
   * @param color    The color to set for the color filter or {@code null} for
   *                 no changes.
  ...
  /**
   * <p>Sets a ColorFilter and/or alpha on all the {@link MenuItem}s in the
   * menu, including the OverflowMenuButton.</p>
   * <p/>
   * <p>Call this method after inflating/creating your menu in {@link
   * Activity#onCreateOptionsMenu(Menu)}.</p>
   * <p/>
   * <p>Note: This is targeted for the native ActionBar/Toolbar, not
   * AppCompat.</p>
   ...
   * menu, including the OverflowMenuButton.</p>
   * <p/>
   * <p>This should only be called after calling {@link #apply(Activity)}. It is
   * useful for when {@link MenuItem}s might be re-arranged due to an action
   * view being collapsed or expanded.</p>
   */
  public void reapply() {
  ...
  public static final class Builder {
    ...
    /**
     * <p>Sets an {@link OnActionExpandListener} on all {@link MenuItem}s with
     * views, so when the menu is updated, the colors will be also.</p>
     * <p/>
     * <p>This is useful when the overflow menu is showing icons and {@link
     * MenuItem}s might be pushed to the overflow menu when a action view is
     * expanded e.g. android.widget.SearchView. </p>
     * @param reapply {@code true} to set the listeners on all {@link MenuItem}s
     *                with action views.
     ...
     * OverflowMenuButton.
     * @param alpha the alpha value for the drawable. 0 means fully transparent,
     ...
     * collapsed.
     * @param color the color to apply on MenuItems when an action-view is
    ...
    /**
     * <p>Sets a ColorFilter and/or alpha on all the MenuItems in the menu,
     * including the OverflowMenuButton.</p>
     * <p/>
     * <p>Call this method after inflating/creating your menu in</p> {@link
     * Activity#onCreateOptionsMenu(Menu)}.</p>
     * <p/>
     * <p>Note: This is targeted for the native ActionBar/Toolbar, not
     * AppCompat.</p>
    ...
    /**
     * <p>Creates a {@link MenuTintHelper} with the arguments supplied to this
     * builder.</p>
     * <p/>
     * <p>It does not apply the theme. Call {@link MenuTintHelper#apply(Activity)}
     * to do so.</p>
     * @see #apply(Activity)
     */
