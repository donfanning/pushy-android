...
class DevicesAdapter extends
  ...
  public DeviceViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    DeviceRowBinding binding = DataBindingUtil
      .inflate(LayoutInflater.from(parent.getContext()), R.layout.device_row,
        parent, false);
  ...
  public void onBindViewHolder(DeviceViewHolder holder, int position) {
    holder.bind(Devices.INST(mContext).get(position), mHandlers);
  }

  @Override
  public int getItemCount() {return Devices.INST(mContext).getCount();}
  ...
  static class DeviceViewHolder extends RecyclerView.ViewHolder {
    ...
    /** Bind the Device */
    void bind(Device device, DevicesHandlers handlers) {
